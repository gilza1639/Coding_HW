...
def auth (database):
    ...
    print('Теперь ты счастлив и на сайте')
    print('Прощай')
    return
...
Вывод - не вижу смысла три раза один алгоритм вставлять, тупо переделав list на словарь в словаре в виде
login_name:{password: 123, 
            is_active: True,
            firstname: YYY,
            lastname: XXX,
            birthday_year: 1999}
